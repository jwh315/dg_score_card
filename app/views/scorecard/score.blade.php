...
<div class="container">
	...
	<div id="leaderboard" class="col-xs-10">
		<div class="text-center">
			<span >Scores will be available shortly</span>
		</div>
	</div>
	<div class="col-xs-1"></div>
</div>
...
<div class="container">
	<div class="row spacer">
		...
		<div class="col-xs-8">
			<button id="toggle_leaderboard" type="button" class="btn btn-default btn-lg btn-block">View Leaderboard</button>
		</div>
		<div class="col-xs-2"></div>
	</div>
</div>